...
module.exports = function (app) {
  ...
  app.get('/tasks/comments/:id', function (req, res, next) {
    var taskId = req.params.id;
    ...
    app.tracker.getOpenTask(taskId, function (err, task) {
      ...
      res.end(task.getComments());
    });
  });

  app.post('/tasks/togglestatus/:id', function (req, res, next) {
    var taskId = req.params.id;
    ...
    app.tracker.getOpenTask(taskId, function (err, task) {
      ...
      task.save(function () {
        res.end(task.ui.statusIconClass);
      });
    });
  });

  app.get('/tasks/shortdescript/:id', function (req, res, next) {
    var taskId = req.params.id;
    ...
    app.tracker.getOpenTask(taskId, function (err, task) {
      ...
      res.end(task.getShortDescription());
    });
  });
      ...
      res.render('task', {
        ...
        getFormHtml: function (fieldMetadata) {
          ...
          if (!fieldValue || fieldValue.length === 0) {
            return "<div class='emptyFieldValue'></div>";
          }
