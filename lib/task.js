...
var Task = module.exports = Class.extend({
  ...
  resolveUI: function (status) {
    if (status) {
      switch(status.toLowerCase()) {
        case 'active':
          this.ui.class = 'info';
          this.ui.statusIconClass = 'icon-folder-close';
          break;
        case 'open':
          this.ui.class = 'success';
          this.ui.statusIconClass = 'icon-folder-close';
          break;
        case 'closed':
          this.ui.class = ''
          this.ui.fontStyle = 'muted done'
          this.ui.statusIconClass = 'icon-folder-open';
          break;
        default:
          this.ui.class = 'info';
          this.ui.statusIconClass = 'icon-folder-open';
  ...
  unassign: function () {
    this.fields['Assigned To'] = '';
  },

  getComments: function () {
    var com;
    if ( this.fields['Comments'] ) {
      com = this.fields['Comments'];
    } else {
      com = 'N/A';
    }
    return com;
